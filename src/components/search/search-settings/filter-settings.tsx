      ...
      <form>
        <fieldset>
          ...
          <div className={styles["setting-group"]}>
            <label>Sort by <Dropdown options={sortOptions} state$={searchOptions$.sortOptions.primarySort} /> </label>
            <button onClick={(e) => reversePrimarySort(e)}>{searchOptions$.sortOptions.isPrimarySortReversed.get() ? "↑" : "↓"}</button>
...
function reversePrimarySort(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) {
  e.preventDefault()
  searchOptions$.sortOptions.isPrimarySortReversed.set(!searchOptions$.sortOptions.isPrimarySortReversed.get())
}